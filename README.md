...
```
.
├── insulator-segmentation.ipynb    # Main training notebook
├── requirements.txt                # Python dependencies
├── samples/                        # Sample images
│   ├── images/                     # Sample input images
│   └── masks/                      # Sample ground truth masks
├── train.zip                       # Training data archive
└── test.zip                        # Test data archive
```
...
Open `insulator-segmentation.ipynb` and run all cells. The notebook includes:
...
See `samples/` directory for example inputs and predictions.
